...
public class Profile implements InfoKey {
	 ...
	 */
	protected Map<Concept, Concept> concepts = new HashMap<>(0);

	protected Map<SocialProperty<?>, Object> socialProperties = new HashMap<>(0);
	...
	public static class TempProfile extends Profile {

		private Profile source;

		public TempProfile(Profile extendedFrom) {
			super(extendedFrom.owner);
			this.source = extendedFrom;
		}

		public boolean isEmpty() {
			return this.concepts.isEmpty() && this.socialProperties.isEmpty();
		}
