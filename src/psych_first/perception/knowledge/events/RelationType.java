...
public class RelationType {
	public static enum MemberType {
		CIRCUMSTANCE, INDIVIDUAL, EITHER;
	...
	public boolean canBeSubject(Object o) {
		if (o instanceof IOccurrence || (o instanceof IProfile ip && ip.getOwner() instanceof IOccurrence)) {
			return this.getSubjectType().allowsCircumstance();
		} else if (o instanceof IHasProfile || (o instanceof IProfile ip)) {
			return this.getSubjectType().allowsIndividual();
		} else {
	...
	public boolean canBePredicate(Object o) {
		if (o instanceof IOccurrence || (o instanceof IProfile ip && ip.getOwner() instanceof IOccurrence)) {
			return this.getPredicateType().allowsCircumstance();
		} else if (o instanceof IHasProfile || (o instanceof IProfile ip)) {
			return this.getPredicateType().allowsIndividual();
		} else {
			throw new IllegalArgumentException();
		}
	}
	...
	/**
	 * returns true if this has a converse or bidirectional
	 * 
	 * @return
	 */
	public boolean hasConverse() {
		return converse != null || this.isBidirectional;
	}
