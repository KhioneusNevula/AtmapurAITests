...
public abstract class SensoryAttribute<T> implements IKnowledgeType<T> {
	...
	private RecognitionLevel recognition = RecognitionLevel.UNRECOGNIZABLE;

	public static enum RecognitionLevel {
		/**
		...
		public boolean moreRecognizableThan(RecognitionLevel other) {
			return this.ordinal() > other.ordinal();
		}

		public boolean lessRecognizableThan(RecognitionLevel other) {
			return this.ordinal() < other.ordinal();
		}
	}

	public SensoryAttribute(String id, Class<T> infoClass, RecognitionLevel rec, Sense... senses) {
		this.id = id;
	 ...
	 * @return
	 */
	public RecognitionLevel getRecognizability() {
		return recognition;
	}
