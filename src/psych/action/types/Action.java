...
public abstract class Action implements IPurposeElement {
	...
	public final int _startExecution(IHasProfile actor, Will will, Task task, Goal requirements, Goal result) {
		return this.startExecution(actor, will, requirements, result);
	}
	 ...
	 */
	protected abstract int startExecution(IHasProfile actor, Will will, Goal requirements, Goal result);
	...
	/**
	 * Determines what the {@link psych.action.ActionType} of this action is; may be
	...
	public String toString() {
		return this.getClass().getSimpleName() + ": " + this.name
				+ (this.origin != null ? " becauseof: " + this.origin : "");
	}
